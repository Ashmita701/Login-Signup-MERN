...
router.post('/create', async (req, res) => {
    ...
    const { name, userName, address, phone_number, password } = req.body;
...
router.patch('/update/:id', async (req, res) => {
    ...
    const { name, username, phone_number, address, password } = req.body;
    try {
        const id = req.params.id;
        updateData = { phone_number: phone_number, address: address };
